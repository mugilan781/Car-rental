...
const AdminDashboard = (() => {
  ...
  const AdminState = {
    adminData: {
      ...
      firstName: 'James',
      lastName: 'Henderson',
      email: 'james.henderson@driveelite.com',
    ...
    userData: [
      {
        ...
        notifications: [
          ...
          { id: 'UN-102', text: 'Welcome to DriveElite Gold Tier!', date: '2024-03-15' }
        ]
      },
      {
        id: 'USR-002',
    ...
    settingsData: {
      business: {
        name: 'DriveElite Luxury Car Rentals Ltd.',
        email: 'ops@driveelite.com',
        phone: '+1 (555) 100-2000',
      ...
      email: {
        smtpHost: 'smtp.driveelite-mail.com',
        smtpPort: '465',
        senderName: 'DriveElite Operations',
        senderEmail: 'no-reply@driveelite.com',
        encryption: 'ssl'
      },
      notifications: {
        bookings: true,
